        ...
        <>
            ...
            <div className="container mx-auto text-center mt-lg-4">
                <div className="row g-3 g-lg-0 g-md-0">
                    <Link className="col-lg col-md col mx-lg-4 mx-2 d-flex justify-content-center align-items-center" style={styleOne}>
                        <p className='p-5'>Pillars of Islam</p>
                    </Link>

                    <Link className="col-lg col-md col mx-lg-4 mx-2 d-flex justify-content-center align-items-center" style={styleTwo}>
                        <p className='p-5'>Articles of Faith</p>
                    </Link>

                    <Link className="col-lg col-md-6 mt-md-4 mt-lg-0 col mx-lg-4 mx-2 d-flex justify-content-center align-items-center mx-md-auto" style={styleThree}>
